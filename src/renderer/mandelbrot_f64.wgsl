/// GPU Shader for Mandelbrot (f64 precision)
...
// 周期2圆盘检测
fn in_period2_bulb(c_re: f64, c_im: f64) -> bool {
...
fn mandelbrot(c_re: f64, c_im: f64, max_iter: u32) -> u32 {
    ...
    var z_re: f64 = 0.0;
    var z_im: f64 = 0.0;
    var z_re_old: f64 = 0.0;
    var z_im_old: f64 = 0.0;
    var period: u32 = 0u;
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let c_re = params.x_min + f64(x) / f64(params.width) * params.x_range;
    let c_im = params.y_min + f64(y) / f64(params.height) * params.y_range;
